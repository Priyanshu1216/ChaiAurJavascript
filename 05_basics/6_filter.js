...
console.log(newNum);        // explicit return (we have to use return keyword)


// or


const newNum1 = nums.filter((num) => num > 4)  // implicit return (we do not have to use return keyword)
...
console.log(clients.filter((client) => client.id > 10));
